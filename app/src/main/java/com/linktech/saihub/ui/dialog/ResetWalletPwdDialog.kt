...
import com.linktech.saihub.databinding.DialogResetWalletBinding
 ...
 * 重置钱包密码提醒弹窗
 */
class ResetWalletPwdDialog : BaseNormalFragment() {


    private var binding: DialogResetWalletBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = DialogResetWalletBinding.inflate(inflater, container, false)
        return binding?.root
    }

...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.github.iielse.switchbutton.R.styleable.SwitchView);
        colorPrimary = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorOff = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_offColor, 0xFFE3E3E3);
        colorOffDark = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_offColorDark, 0xFFBFBFBF);
        colorShadow = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_shadowColor, 0xFF333333);
        colorBar = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_barColor, 0xFFFFFFFF);
        colorBackground = a.getColor(com.github.iielse.switchbutton.R.styleable.SwitchView_bgColor, 0xFFFFFFFF);
        ratioAspect = a.getFloat(com.github.iielse.switchbutton.R.styleable.SwitchView_ratioAspect, 0.68f);
        hasShadow = a.getBoolean(com.github.iielse.switchbutton.R.styleable.SwitchView_hasShadow, true);
        isOpened = a.getBoolean(com.github.iielse.switchbutton.R.styleable.SwitchView_isOpened, false);

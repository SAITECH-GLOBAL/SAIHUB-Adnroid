...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context) {
        ...
        mVerticalDivider = context.getResources().getDrawable(R.drawable.divider_decoration);
        mHorizontalDivider = context.getResources().getDrawable(R.drawable.divider_decoration_vertical);
    }
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            } else if (isLastColum(parent, i, getSpanCount(parent), childCount))//如果是最后一列
            {
                ...
                final int left = child.getLeft();
                final int right = child.getRight() + mVerticalDivider.getIntrinsicWidth();
                final int top = child.getBottom() + params.bottomMargin;
                final int bottom = top + mVerticalDivider.getIntrinsicHeight();
                mVerticalDivider.setBounds(left, top, right, bottom);
                mVerticalDivider.draw(c);
...
//                return true;
    ...
    public void getItemOffsets(Rect outRect, int itemPosition,
        ...
        int marginRight = mVerticalDivider.getIntrinsicWidth();
        int marginBottom = mHorizontalDivider.getIntrinsicHeight();

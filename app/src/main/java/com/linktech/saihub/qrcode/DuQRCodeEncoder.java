package com.linktech.saihub.qrcode;
...
public class DuQRCodeEncoder {
    ...
    public static Bitmap syncEncodeQRCode(String content, int size, int foregroundColor, int backgroundColor, Bitmap logo) {
        try {
            BitMatrix matrix = new DuMultiFormatWriter().encode(content, BarcodeFormat.QR_CODE, size, size, HINTS);
    ...
    public static Bitmap syncEncodeBarcode(String content, int width, int height, int textSize) {
        ...
        try {
            BitMatrix bitMatrix = new DuMultiFormatWriter().encode(content, BarcodeFormat.CODE_128, width, height, hints);
